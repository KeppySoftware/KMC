...
7za a -t7z -m0=lzma -mx=9 -mfb=64 -md=32m -ms=on bin\KeppyMIDIConverterPortable.7z bin\x86\basswasapi.dll
...
7za a -t7z -m0=lzma -mx=9 -mfb=64 -md=32m -ms=on bin\KeppyMIDIConverterPortable.7z bin\x64\basswasapi.dll
